...
<?php $__env->startSection('header-actions'); ?>
    <button onclick="toggleFilter()"
        ...
        Filter
        <?php if(request()->hasAny(['search', 'status', 'company_id', 'department_id', 'area_id', 'sub_area_id', 'object_type'])): ?>
            <span class="inline-flex items-center justify-center w-5 h-5 text-xs font-bold text-white bg-blue-500 rounded-full"><?php echo e(collect([request('search'), request('status'), request('company_id'), request('department_id'), request('area_id'), request('sub_area_id'), request('object_type')])->filter()->count()); ?></span>
        <?php endif; ?>
    </button>
    <a href="<?php echo e(route('assets.export-excel', request()->query())); ?>"
    ...
    <a href="<?php echo e(route('assets.export-csv', request()->query())); ?>"
...
<?php $__env->startSection('content'); ?>
    ...
    <div id="filterPanel" class="bg-white rounded-xl border border-slate-200 mb-6 overflow-hidden transition-all duration-200 ease-in-out"
        ...
        <div class="p-5">
            ...
            <form method="GET" action="<?php echo e(route('assets.index')); ?>" id="filterForm">
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
                    ...
                    <div>
                        ...
                        <select name="status" class="w-full border border-slate-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white">
                            ...
                            <option value="needs_review" <?php echo e(request('status') === 'needs_review' ? 'selected' : ''); ?>>Perlu Review</option>
                        </select>
                    </div>
                    <div>
                        ...
                        <select name="object_type" class="w-full border border-slate-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white">
                            ...
                            <?php $__currentLoopData = $objectTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($type); ?>" <?php echo e(request('object_type') === $type ? 'selected' : ''); ?>><?php echo e($type); ?></option>
                        ...
                        <div>
                            ...
                            <select name="company_id" onchange="this.form.submit()"
                                ...
                                <?php $__currentLoopData = $companies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $company): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($company->id); ?>" <?php echo e(request('company_id') == $company->id ? 'selected' : ''); ?>><?php echo e($company->code); ?> — <?php echo e($company->name); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                        <div>
                            ...
                            <select name="department_id" onchange="this.form.submit()"
                                ...
                                <?php $__currentLoopData = $departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dept): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($dept->id); ?>" <?php echo e(request('department_id') == $dept->id ? 'selected' : ''); ?>><?php echo e($dept->code); ?> — <?php echo e($dept->name); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                        <div>
                            ...
                            <select name="area_id" onchange="this.form.submit()"
                                ...
                                <?php $__currentLoopData = $areas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $area): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($area->id); ?>" <?php echo e(request('area_id') == $area->id ? 'selected' : ''); ?>><?php echo e($area->code); ?> — <?php echo e($area->name); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                        <div>
                            ...
                            <select name="sub_area_id"
                                ...
                                <?php $__currentLoopData = $subAreas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($sub->id); ?>" <?php echo e(request('sub_area_id') == $sub->id ? 'selected' : ''); ?>><?php echo e($sub->code); ?> — <?php echo e($sub->name); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                    </div>
                ...
                <div class="flex items-center gap-3 pt-2 border-t border-slate-100">
                    ...
                    <a href="<?php echo e(route('assets.index')); ?>" class="px-5 py-2 border border-slate-300 hover:bg-slate-50 text-slate-700 text-sm font-medium rounded-lg transition-colors">
                        Reset Filter
                    </a>
                </div>
            </form>
        ...
        <div class="flex flex-wrap items-center gap-2 mb-4">
            ...
            <?php $__currentLoopData = $activeFilters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $filter): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <span class="inline-flex items-center gap-1.5 px-3 py-1.5 bg-blue-50 border border-blue-200 text-blue-700 text-xs font-medium rounded-full">
                    ...
                    <a href="<?php echo e(route('assets.index', request()->except($filter['key']))); ?>" class="text-blue-400 hover:text-blue-600 transition-colors">
            ...
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <a href="<?php echo e(route('assets.index')); ?>" class="text-xs text-slate-400 hover:text-red-500 transition-colors ml-1">
                Hapus semua
            </a>
        </div>
    <?php endif; ?>
                        ...
                        <tr class="hover:bg-slate-50 transition-colors">
                            <td class="px-5 py-3.5">
                                <div class="flex flex-col">
                                    <span class="font-mono text-sm font-medium text-slate-900"><?php echo e($asset->tech_ident_no ?? '-'); ?></span>
                                    <?php if($asset->equipment_no): ?>
                                        <span class="text-[10px] text-slate-400 font-mono mt-0.5">EQ: <?php echo e($asset->equipment_no); ?></span>
                                    <?php endif; ?>
                                </div>
                            </td>
                            <td class="px-5 py-3.5">
                                <p class="text-slate-700"><?php echo e(Str::limit($asset->description, 60)); ?></p>
                            </td>
                            <td class="px-5 py-3.5">
                                <span class="inline-flex px-2 py-0.5 text-xs font-medium bg-slate-100 text-slate-700 rounded">
                                    <?php echo e($asset->object_type ?? '-'); ?>

                                </span>
                            </td>
                            <td class="px-5 py-3.5">
                                <div class="text-xs text-slate-600">
                                    <span><?php echo e($asset->company?->code ?? '-'); ?></span>
                                    <?php if($asset->department): ?>
                                        <span class="mx-0.5 text-slate-300">/</span>
                                        <span><?php echo e($asset->department->code); ?></span>
                                    <?php endif; ?>
                                    <?php if($asset->area): ?>
                                        <span class="mx-0.5 text-slate-300">/</span>
                                        <span class="font-medium text-slate-700"><?php echo e($asset->area->code); ?></span>
                                    <?php endif; ?>
                                    <?php if($asset->subArea): ?>
                                        <span class="mx-0.5 text-slate-300">/</span>
                                        <span><?php echo e($asset->subArea->code); ?></span>
                                    <?php endif; ?>
                                </div>
                                <?php if($asset->functional_loc): ?>
                                    <p class="text-[10px] text-slate-400 mt-0.5 font-mono"><?php echo e($asset->functional_loc); ?></p>
                                <?php endif; ?>
                            </td>
                            <td class="px-5 py-3.5">
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <tr>
                            <td colspan="6" class="px-5 py-8 text-center text-sm text-slate-400">
                                Belum ada asset. <a href="<?php echo e(route('assets.import')); ?>" class="text-blue-600 hover:underline">Import dari Excel</a>
                            </td>
                        </tr>
                    <?php endif; ?>
                </tbody>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ASUS\oleochemicalReport\resources\views/assets/index.blade.php ENDPATH**/ ?>