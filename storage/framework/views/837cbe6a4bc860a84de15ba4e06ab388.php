...
<div class="bg-white rounded-xl border border-slate-200 p-5">
    <div class="flex items-start justify-between">
        <div>
            <p class="text-xs font-medium text-slate-500 uppercase tracking-wide"><?php echo e($label); ?></p>
            <p class="text-2xl font-bold mt-1 <?php echo e($valueColor); ?>"><?php echo e($value); ?></p>
            <?php if($subtext): ?>
                <p class="text-xs text-slate-500 mt-1"><?php echo e($subtext); ?></p>
            <?php endif; ?>
        </div>
        <?php if($iconHtml): ?>
...
<?php /**PATH C:\Users\ASUS\oleochemicalReport\resources\views/components/stat-card.blade.php ENDPATH**/ ?>